        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
					...
					$filename 	= images::image_id() + 1;
					$filetype = utility::split_str($type, '/');
					$new_filename = $filename . '.' . $filetype;
					
                    move_uploaded_file($uploaded_file, $file_path);
					rename($doc_root.'/placio/php/files/'.$name, $doc_root.'/placio/php/files/'.$new_filename);
					images::save($place_id, $new_filename);
                }
            } else {
